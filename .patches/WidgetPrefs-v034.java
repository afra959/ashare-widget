...
public final class WidgetPrefs {
    ...
    public static String alertsRaw(Context c, int id) {
        return prefs(c).getString("alerts_" + id, "");
    }
    ...
    /**
     * Canonical symbols used by the app.
     *
     * Tencent:
     *   sh/sz/bj + six digits
     * Sina:
     *   hf_* global futures, gb_* US securities/indices, fx_* forex
     *
     * Old Yahoo symbols remain accepted as aliases so older notes/configs still work.
     */
